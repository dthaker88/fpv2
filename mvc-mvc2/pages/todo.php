...
<form action="index.php?page=tasks&action=create" method="post">
   <!-- <div class="form-group">
    ...
    Due Date: <input type="text" name="duedate" value = "<php $data->duedate; ?>"><br>
    Message: <input type="text" name="message" value = "<php $data->message; ?>"><br>
    Is done?: <input type="text" name="isdone" value = "<php $data->isdone; ?>"><br>
